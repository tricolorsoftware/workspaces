...
const UKExtendedFloatingActionButton: Component<{
    ...
    return (
        <button class={clsx(styles.root, props.class)} data-size={props.size} data-color={props.color} onClick={props.onClick}>
